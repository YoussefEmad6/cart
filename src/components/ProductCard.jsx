  ...
  return (
    <CardWrapper>
      ...
      <ProductCardButtons>
        ...
        {isInFav(product) ? (
          <Button onClick={() => favoritfavoRem(product)}>
            REMOVE to FAVO
          </Button>
        ) : (
          <Button onClick={() => favoritfavoAdd(product)}>Add to FAVO</Button>
        )}
        {/* <Button onClick={() => favoritfavoAdd(product)}>Add to FAVO</Button>
        <Button onClick={() => favoritfavoRem(product)}>REMOVE to FAVO</Button> */}
      </ProductCardButtons>
    </CardWrapper>
  );
};
