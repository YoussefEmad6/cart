...
const storage = localStorage.getItem("cartItems")
  ...
  : [];
const favorit = localStorage.getItem("favo")
...
const CartState = ({ children }) => {
  ...
  const favoritfavoAdd = (payload) => {
    dispatch({ type: "ADD_FAVO", payload });
  };
  const favoritfavoRem = (payload) => {
    dispatch({ type: "REM_FAVO", payload });
  };
